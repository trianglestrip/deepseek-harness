...
/**
 * The system addon holds the session lock's exclusive flock, which replaced the
 * fs-ext binding. Its prebuilt libraries cover macOS and Linux, so a platform
 * without one reports the unsupported platform instead.
 */
